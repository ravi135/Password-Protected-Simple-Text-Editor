	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == register && passTF.getPassword().length > 0 && userTF.getText().length() > 0) {
			...
			if(pass.equals(confirm)){
				try {
					BufferedReader input = new BufferedReader(new FileReader("src/passwords.txt"));
					...
					BufferedWriter output = new BufferedWriter(new FileWriter("src/passwords.txt",true));
